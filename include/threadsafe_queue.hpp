...
namespace Bonostl
{
    ...
    private:
        ...
        node* get_tail()
        {
            std::lock_guard<T> tail_lock(tail_mutex);
            return tail;
        }
        ...
        {
            std::unique_lock<T> head_lock(head_mutex);
        ...
        {
            std::unique_lock<T> head_lock(wait_for_data());
            return pop_head();
        }
        ...
        {
            std::lock_guard<T> head_lock(head_mutex);
